                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="col-sm-3 col-md-3 pull-left">
                        <form action="/MobileHub/index.php/question/search" class="navbar-form" method="get" role="search" id="searchForm" name="searchForm">
                            <div class="input-group">
                                <input class="form-control" id="search-term" name="q" placeholder="Search" type="text" data-toggle="popover" data-placement="bottom" title="" data-content="You need to enter atleast 3 characters to search" role="button" data-original-title="Quick Tip" x-webkit-speech="true">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if ($name == NULL) {
                            ...
                            echo '<li><a href="' . site_url('questions/ask') . '" style="padding: 0; margin-right: 10px; margin-top: 14px"><button class="btn btn-success askBtnStyle" role="button">Ask a question</button></a></li>';
